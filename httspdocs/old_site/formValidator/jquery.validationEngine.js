...
(function($) {
	...
	if($.validationEngineLanguage){				// IS THERE A LANGUAGE LOCALISATION ?
		...
		allRules = 	{"required":{    			// Add your regex rules here, you can take telephone as an example
						...
						"alertTextCheckboxMultiple":"* Por favor elija una opcion",
						"alertTextCheckboxe":"* Este elemento es requerido"},
					"length":{
						"regex":"none",
						"alertText":"*Entre ",
						"alertText2":" y ",
					...
					"maxCheckbox":{
						"regex":"none",
						"alertText":"* Opciones excedidas"},	
					"minCheckbox":{
						"regex":"none",
						"alertText":"* Por favor selecciones ",
						"alertText2":" opciones"},	
					"confirm":{
						"regex":"none",
						"alertText":"* El campo no es igual"},		
					"telephone":{
						"regex":"/^[0-9\-\(\)\ ]+$/",
					...
					"date":{
                         ...
                         "alertText":"* Fecha invalida, El formato debe ser AAAA-MM-DD "},
					"onlyNumber":{
						"regex":"/^[0-9\ ]+$/",
						"alertText":"* Numeros solamente"},	
					"noSpecialCaracters":{
						"regex":"/^[0-9a-zA-Z]+$/",
						"alertText":"* Los caracteres especiales no estan permitidos"},	
					"ajaxUser":{
						"file":"validateUser.php",
						"alertTextOk":"* Nombre esta disponible",	
						"alertTextLoad":"* Cargando, por favor espere",
						"alertText":"* Nombre no disponible"},	
					"ajaxName":{
						"file":"validateUser.php",
						"alertText":"* Nombre no disponible",
